...
- If you added unit tests in a backwards-compatible way then you can increase the minor release.
- If the unit test fails then you need to fix the failing tests and increase the major release.
