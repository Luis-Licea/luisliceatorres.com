...
- On 6, as she is passing by, draw a clockwise halo over her head without releasing your right-hand grip.
- End in a {{% a "left hammerlock" %}} position with both hands in a {{% a "left-down-out" %}} position, with the right hand against the follower's right hip.
