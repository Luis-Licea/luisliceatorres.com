...
- Steps 1 and 2 are to your left
such that the right leg hooks behind the left. You should walk perpendicular to
the slot on steps 1 and 2.
- Step 3&4 requires you to push the follower at the
...
forearm, and hand. 
- You should be in [weird handshake] position by the time you
do an anchor step.
