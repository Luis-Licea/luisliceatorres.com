...
Whenever you are in a [closed] or [starter] position, your first two steps are half the length, so the {{% a "left prep" %}} for the inside chain turn will happen on 2 rather than between 1 and 2. [^2]
