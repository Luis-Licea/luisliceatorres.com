...
- [Closed]({{% relref "./closed.md" %}})
- [Starter]({{% relref "./starter.md" %}})
- [Open]({{% relref "./open.md" %}})
    - [Horn]({{% relref "./open-horn.md" %}})
    - [Spiderman]({{% relref "./open-spiderman.md" %}})
    - [Weird]({{% relref "./open-weird.md" %}})

- [Goofy]({{% relref "./goofy.md" %}})
    - [Horn]({{% relref "./goofy-horn.md" %}})
    - [Spiderman]({{% relref "./goofy-spiderman.md" %}})
    - [Weird]({{% relref "./goofy-weird.md" %}})

- [Handshake]({{% relref "./handshake.md" %}})
    - [Horn]({{% relref "./handshake-horn.md" %}})
    - [Spiderman]({{% relref "./handshake-spiderman.md" %}})
    - [Weird]({{% relref "./handshake-weird.md" %}})

- [Scout]({{% relref "./scout.md" %}})
    - [Horn]({{% relref "./scout-horn.md" %}})
    - [Spiderman]({{% relref "./scout-spiderman.md" %}})
    - [Weird]({{% relref "./scout-weird.md" %}})
