...
[Handhold configurations]({{% relref "./handhold/_index.md" %}})

## Stance configurations

[Stance configurations]({{% relref "./stance/_index.md" %}})
...
[Sugar pushes]({{% relref "./sugar-push/_index.md" %}})
